...
interface CreditCardLockIconProps extends SvgProps {
  width?: number;
  height?: number;
  color?: string;
  style?: any;
...
const CreditCardLockIcon: React.FC<CreditCardLockIconProps> = ({
  width = s(20),
  height = s(20),
  color,
  style,
    ...
    <ViewComponent style={style}>
      ...
      >
        <Path
          ...
          stroke={color || "#898A8D"} // Or use: stroke={color || NEW_COLOR.TEXT_ALWAYS_BLACK}
          strokeWidth={1.5}
          strokeLinecap="round"
