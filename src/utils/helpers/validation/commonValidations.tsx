const VALID_STATE_REGEX = /^[0-9\s\/\-,.#()&A-Za-z]+$/; // Allowed characters
const CONTAINS_LETTER = /[A-Za-z]/; // Check if it has a letter
const CONTAINS_NUMBER = /\d/; // Check if it has a number
const CONTAINS_SPECIAL_CHAR = /[\/\-,.#()&]/; // Check for special characters
