...
import { ActivityIndicator, Alert, BackHandler, Image, Keyboard, Modal, Platform, ScrollView, StyleSheet, TouchableOpacity, TouchableWithoutFeedback, View } from 'react-native';
