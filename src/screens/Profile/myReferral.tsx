...
const MyReferrals = (props: any) => {
  ...
  const getReferrals = async () => {
    if (!isLoading && isMoreData) {
      try {
        setIsLoading(true);
        const response: any = await ProfileService.getAllReferrals(
          "",
          pageNo,
          10
        );
        if (
          ...
          setIsMoreData(response.data?.length === 10);
          setPageNo(pageNo + 1);
          setErrorMsg("");
          setIsLoading(false);
        } else {
  ...
  const renderFooter = () => {
    ...
    return <Loadding contenthtml={CardListLoader} />;
  };
      ...
      <>
        ...
        >
          <View style={[commonStyles.flex1]}>
            ...
            >
              <ParagraphComponent
                text={PROFILE_CONSTANTS.CUSTOMER_NAME}
                style={[
                  commonStyles.fs10,
                  commonStyles.fw500,
              ...
              />
              <ParagraphComponent
                text={PROFILE_CONSTANTS.JOIN_DATE}
                style={[
                  commonStyles.fs10,
                  commonStyles.fw500,
                  commonStyles.textGrey,
            ...
            >
              ...
              />
              <ParagraphComponent
                text={formatOnlyDateLocal(item?.date) || ""}
                style={[
                  commonStyles.fs14,
                  commonStyles.fw500,
                  commonStyles.textBlack,
  ...
  return (
    <SafeAreaView
      style={[commonStyles.screenBg, commonStyles.relative, commonStyles.flex1]}
    >
      <ScrollView>
        <Container style={[commonStyles.container]}>
          ...
          >
            <TouchableOpacity style={[styles.px8]} onPress={handleGoBack}>
              <View>
                <AntDesign
                  name={PROFILE_CONSTANTS.ARROW}
                  size={s(22)}
            ...
            <ParagraphComponent
              ...
              text={PROFILE_CONSTANTS.MY_REFERRALS}
            />
          </View>
          {errorMsg && (
          ...
          <ParagraphComponent
            ...
            text={PROFILE_CONSTANTS.REFERRAL_CODE}
          />
          {(referelDataLoading && (
            <>
          ...
          <ParagraphComponent
            ...
            text={PROFILE_CONSTANTS.REFERRALS_S}
          />
          <View style={[commonStyles.mt10, commonStyles.mb16]}>
            <View style={[]}>
              <FlatList
                ...
                ListEmptyComponent={() => (
                  <>
                    {!isLoading && referralsList?.length < 1 && (
                      <NoDataComponent />
                    )}
                  </>
                )}
