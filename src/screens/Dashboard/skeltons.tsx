...
export const ProductCardLoader = (count: number) => {
    let countList = [0];
    if (count) {
    ...
    const html = <View style={[commonStyles.dflex, commonStyles.flexWrap, commonStyles.gap14]}>
        {countList.map((item) => (
            <View key='item' style={{ width: WINDOW_WIDTH * 0.44 }}>
                <View style={{ ...styles.textSkeleton, width: '100%', height: 200, marginBottom: 10, borderRadius: 5 }} />
                <View style={{ ...styles.textSkeleton, width: '100%', height: 19, marginBottom: 11, borderRadius: 2 }} />
                <View style={{ ...styles.textSkeleton, width: '100%', height: 14, marginBottom: 6, borderRadius: 2 }} />
                <View style={{ ...styles.textSkeleton, width: '60%', height: 14, marginBottom: 11, borderRadius: 2 }} />
                <View style={[commonStyles.dflex, commonStyles.alignCenter, commonStyles.gap10]}>
                    <View style={{ ...styles.textSkeleton, width: '45%', height: 19, borderRadius: 2 }} />
                    <View style={{ ...styles.textSkeleton, width: '45%', height: 19, borderRadius: 2 }} />
                </View>
            </View>
        ))}
...
export const transactionCard = (count: number) => {
    ...
    const html = <View >
        {countList.map((item) => (
            <View key={item} style={{ ...styles.textSkeleton, width: '100%', height: 60, borderRadius: 8,  marginBottom: 10 }} />))}
    </View>;
    return html;
};
