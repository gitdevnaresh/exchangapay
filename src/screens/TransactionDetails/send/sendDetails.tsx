...
const SendDetails: React.FC<any> = ({ transaction }) => {
    ...
    <ViewComponent>
      ...
      <ViewComponent style={detailRowStyles.rowContainer}>
        <ViewComponent style={detailRowStyles.rowContent}>
          ...
          <ParagraphComponent style={[commonStyles.fs14, commonStyles.fw500, commonStyles.textWhite]}>{decryptAES(userInfo.userName) || ''}</ParagraphComponent>
        </ViewComponent>
      </ViewComponent>
      ...
      {transaction?.note && <ViewComponent style={[commonStyles.transaction_bg]}>
        <TextMultiLanguage style={[commonStyles.fs12, commonStyles.fw400, commonStyles.textlinkgrey]} text={"Note"} />
        <ParagraphComponent style={[commonStyles.fs14, commonStyles.fw500, commonStyles.textWhite, commonStyles.textRight, { width: "60%" }]} numberOfLines={3}>{transaction?.note || ''}</ParagraphComponent>

      </ViewComponent>}


      {transaction?.purposeOfTransfer && <ViewComponent style={detailRowStyles.rowContainer}>
        <ViewComponent style={detailRowStyles.rowContent}>
          <ParagraphComponent style={[commonStyles.fs12, commonStyles.fw400, commonStyles.textlinkgrey]}>Puropose Of Transfer</ParagraphComponent>
          <ViewComponent style={[commonStyles.dflex, commonStyles.alignCenter, commonStyles.gap8]}>
            <ParagraphComponent style={[commonStyles.fs14, commonStyles.fw500, commonStyles.textWhite]}>{transaction?.purposeOfTransfer || ''}</ParagraphComponent>
          </ViewComponent>
        </ViewComponent>
      </ViewComponent>}

      {transaction?.relationShipWithRecipient && <ViewComponent style={detailRowStyles.rowContainer}>
        <ViewComponent style={detailRowStyles.rowContent}>
          <ParagraphComponent style={[commonStyles.fs12, commonStyles.fw400, commonStyles.textlinkgrey]}>Relationship With Recipient</ParagraphComponent>
          <ViewComponent style={[commonStyles.dflex, commonStyles.alignCenter, commonStyles.gap8]}>
            <ParagraphComponent style={[commonStyles.fs14, commonStyles.fw500, commonStyles.textWhite]}>{transaction?.relationShipWithRecipient || ''}</ParagraphComponent>
          </ViewComponent>
        </ViewComponent>
      </ViewComponent>}
