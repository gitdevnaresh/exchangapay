...
const CardDetails: React.FC<CardDetailsProps> = ({ transaction }) => {
    ...
    return (
      <ViewComponent >
        ...
        <ViewComponent style={[commonStyles.dflex, commonStyles.alignCenter, commonStyles.justifyContent]}>
          ...
          <ParagraphComponent text={formatDateTimeHour(transaction?.txDate||transaction?.dateTime || '--')} style={[commonStyles.fs14, commonStyles.fw500, commonStyles.textWhite]} />
        </ViewComponent>
        <ViewComponent style={[commonStyles.listGap]} />
        {/* Amount */}
        <ViewComponent style={[commonStyles.dflex, commonStyles.alignCenter, commonStyles.justifyContent, commonStyles.gap16]}>
        ...
        {/* Remarks */}
        {transaction?.remarks && (
          <ViewComponent style={[commonStyles.dflex, commonStyles.alignCenter, commonStyles.justifyContent, commonStyles.gap16,{flexWrap: "wrap"}]}>
