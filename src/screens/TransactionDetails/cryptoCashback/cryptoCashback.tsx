...
const CryptoCashBack: React.FC<DepositDetailsProps> = ({ transaction }) => {
    ...
    <ViewComponent>
      ...
      <ViewComponent style={detailRowStyles.rowContainer}>
        <ViewComponent style={detailRowStyles.rowContent}>
          ...
          <ParagraphComponent style={[commonStyles.fs14, commonStyles.fw500, commonStyles.textWhite]}>{transaction?.percentage && transaction.percentage + "%" ||""}</ParagraphComponent>
        </ViewComponent>
      </ViewComponent>
      ...
      {transaction?.volume && (
        <ViewComponent style={detailRowStyles.rowContainer}>
          <ViewComponent style={detailRowStyles.rowContent}>
            <TextMultiLanguage style={[commonStyles.fs12, commonStyles.fw400, commonStyles.textlinkgrey]} text={"GLOBAL_CONSTANSTS.PAID"}/>
