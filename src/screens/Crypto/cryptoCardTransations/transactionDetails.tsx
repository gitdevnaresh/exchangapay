...
const TransactionDetails = React.memo(
  ({ transId, closePop }: { transId: string; closePop: () => void }) => {
    ...
    const getTransactionDetails = async () => {
      try {
        const response: any = await CardsModuleService.getTransactionDetails(
          transId
        );
        if (response?.data) {
    ...
    const hyperLinkHash = transactionDetails?.explorer?.concat(
        ...
        <ScrollView>
          <View>
              ...
              >
                ...
                {transactionDetails?.transactionId && (
                  <View style={{ marginTop: isPad ? 0 : 4 }}>
                    <CopyCard
                      onPress={() =>
                        copyToClipboard(transactionDetails?.transactionId)
                      }
                      iconShow={true}
                      contentShow={false}
                    />
            ...
            >
              ...
              <ParagraphComponent
                text={formatCurrency(
                  transactionDetails?.action === "Consume" &&
                    transactionDetails?.state === "Approved"
            ...
            {transactionDetails?.action === "Withdraw" &&
              (transactionDetails?.comission ||
                transactionDetails?.comission == 0) && (
                <View>
                  <View
                    style={[
                      commonStyles.dashedLine,
            ...
            {transactionDetails?.action === "Withdraw" &&
              (transactionDetails?.withdrawAmount ||
                transactionDetails?.withdrawAmount == 0) && (
                <View>
                  <View
                    style={[
                      commonStyles.dashedLine,
                ...
                <View>
                  ...
                  >
                    ...
                    <View style={{ marginTop: isPad ? 6 : 4 }}>
                      <CopyCard
                        onPress={() =>
                          copyToClipboard(transactionDetails?.from)
                        }
                        iconShow={true}
                        contentShow={false}
                      />
                ...
                <View>
                  ...
                  >
                    ...
                    <View style={{ marginTop: isPad ? 6 : 4 }}>
                      <CopyCard
                        onPress={() =>
                          copyToClipboard(transactionDetails?.receiveWallet)
                        }
                        iconShow={true}
                        contentShow={false}
                      />
