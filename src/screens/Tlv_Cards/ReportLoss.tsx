...
import { View, ScrollView, TouchableOpacity, Image, ImageBackground, BackHandler } from 'react-native';
...
const ReportLossComponent = React.memo((props: any) => {
    ...
    const handleReportLoss = async () => {
        ...
        let Obj = {
            ...
            status: 1,
            actionBy: "Report Loss"
        }
        try {
            const res: any = await CardsModuleService.saveReportLoss(cardId, Obj);
            if (res.status === 200) {
                props.navigation.navigate("CardDetails", {
                    cardId: props?.route?.params?.cardId
                });
                ...
                <Container style={[commonStyles.container,]}>
                    <View style={[commonStyles.dflex, commonStyles.alignCenter, commonStyles.gap16, commonStyles.justifyContent]}>
                        <View style={[commonStyles.dflex, commonStyles.alignCenter, commonStyles.gap8]}>
                            ...
                            <ParagraphComponent text="Report Loss" style={[commonStyles.fs16, commonStyles.textBlack, commonStyles.fw800]} />
                        </View>
                    </View>
                    ...
                    <ImageBackground source={require("../../assets/images/cards/light-purplebg.png")} resizeMode="contain" style={[{ position: "relative", height: 385, }]} >
                        <View style={[commonStyles.relative]}>
                            ...
                            <Image style={[commonStyles.mxAuto, styles.mt44]} source={require("../../assets/images/cards/report.png")} resizeMode="cover" />
                            <ParagraphComponent text='Report Loss' style={[commonStyles.fs24, commonStyles.fw700, commonStyles.textBlack, commonStyles.textCenter, commonStyles.mt16]} />
                            ...
                            <ParagraphComponent text='Report the loss?' style={[commonStyles.fs14, commonStyles.fw700, commonStyles.textBlack, commonStyles.textCenter, commonStyles.mb24]} />
...
export default ReportLossComponent;
