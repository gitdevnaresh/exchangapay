...
import { SignupValidationSchema } from '../../onboarding/signup/signUpShema';
import { useDispatch, useSelector } from 'react-redux';
import { setReferralCode, setSignupInfo } from '../../../redux/actions/actions';
import { ReferralInfo, SignupFormValues } from '../../onboarding/interfaces';
...
const FrontEggSignup = () => {
    ...
    const handleSignup = async (values: SignupFormValues, setFieldError: any) => {
        ...
        try {
            ...
            const response: any = await OnboardingService.sendEmail(body);
            if (response.status === 200) {
                ...
                navigation.navigate("frontEggEmailVerification");
                return;
        ...
        <ViewComponent style={[commonStyles.flex1, commonStyles.screenBg]}>
            ...
            >
                ...
                <Container style={[commonStyles.container, { flex: 1 }]}>
                    <ViewComponent>
                        <PageHeader onBackPress={handleGoBack} title={t('GLOBAL_CONSTANTS.SIGN_UP')} disable={loading} />
                    </ViewComponent>
                            ...
                            <>
                                ...
                                <ViewComponent style={[commonStyles.mt30]}>
                                    <ButtonComponent
                                        ...
                                        loading={loading}
                                        disable={loading || !values.termsAccepted || !values.email?.trim() || Object.keys(errors).length > 0}
                                    />
                                </ViewComponent>
