...
const Card = (props: any) => {
  ...
  return (
    <ViewComponent>
      ...
      {/* Common fields */}
      {renderFieldIfExists?.("GLOBAL_CONSTANTS.TRANSACTIONS_TYPE", transactionIdList?.type)}
      {renderTransactionField?.("GLOBAL_CONSTANTS.TRANSACTIONS_WALLET", transactionIdList?.wallet || "")}
      {renderTransactionField?.("GLOBAL_CONSTANTS.WALLET_NAME", transactionIdList?.name || "")}
