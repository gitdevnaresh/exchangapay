    ...
    <SafeAreaView style={[commonStyles.flex1, commonStyles.screenBg]}>
      <ScrollView>
        <Container style={commonStyles.container}>
          ...
          <TopNavigation style={[commonStyles.gap24, { padding: 0, backgroundColor: CONSTANTS?.TRANSPARENT }]}
            accessoryLeft={(): TouchableWebElement =>
              <View>
                <View style={[commonStyles.dflex, commonStyles.alignCenter, commonStyles.gap4]}>
                  <View
                    style={{ width: s(27), height: s(25) }}

                  >
                    <LogoxWhite width={s(26)}
                      height={s(24)} />
                  </View>
                  <ParagraphComponent text={CONSTANTS?.EXCHANGA_PAY} style={[commonStyles.fs22, commonStyles.fw700, commonStyles.textLogo, { marginTop: -4 }]} />
                </View>
              </View>
            }
          />
          ...
          {!htmlContent?.message&&
            <Container style={[commonStyles.container, commonStyles.flex1, commonStyles.dflex, commonStyles.alignCenter]}>
              <View style={commonStyles.flex1}>
                ...
                <IconRefresh height={s(40)} width={s(40)} style={[commonStyles.mxAuto]} />
                <View style={[commonStyles.mb24]} />
                <ParagraphComponent style={[commonStyles.textCenter, commonStyles.textBlack, commonStyles.fs16, commonStyles.fw800]} text={"Your account is Inprogress"} />
                <View style={[commonStyles.mb8]} />
                <ParagraphComponent style={[commonStyles.textCenter, commonStyles.textBlack, commonStyles.fs14, commonStyles.fw600]} text={"please contact support"} />
