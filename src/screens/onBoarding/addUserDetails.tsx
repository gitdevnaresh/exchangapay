...
import { EMAIL_CONSTANTS, FormValues, USER_CONSTANTS, userValidationSchema } from "../../screens/onBoarding/constants";
import { formatDateMonth, formatDateTimeAPI, isErrorDispaly } from "../../utils/helpers";
            ...
            <ScrollView keyboardShouldPersistTaps="handled">
                <Container style={commonStyles.container}>
                    <View style={[commonStyles.mb24, commonStyles.mt8]}>
                        ...
                        <ParagraphComponent style={[commonStyles.fs24, commonStyles.textBlack, commonStyles.fw600, commonStyles.textCenter, commonStyles.mb36]} text={"Let's Get You Started"} />
                    </View>
                        ...
                        {({ handleSubmit, errors, setFieldValue }) => (
                            <>
                                ...
                                <View style={styles.fieldContainer}>
                                    ...
                                    />
                                    <View style={[styles.datePickerContainer, commonStyles.dflex, commonStyles.alignCenter, commonStyles.justifyContent]}>
                                        <ParagraphComponent
                                            text={
                                                dateOfBirth
                                ...
                                <View style={[commonStyles.dflex, commonStyles.alignCenter, commonStyles.justifyCenter]}>
                                    <TouchableOpacity onPress={handleLgout} style={[commonStyles.px10]} disabled={saveLoading}>
                                        <ParagraphComponent text={EMAIL_CONSTANTS.LOG_OUT} style={[commonStyles.alignCenter, commonStyles.textOrange, commonStyles.fs18]} />
