...
interface PaymentsActiveIconProps extends SvgProps {
  width?: number;
  height?: number;
  style?: any;
...
const PaymentsActiveIcon: React.FC<PaymentsActiveIconProps> = ({
  width = s(24),
  height = s(24),
  style,
  color,
  ...
  const fillColor = color || NEW_COLOR.BOTTOM_TABS || "#94A3BB";
