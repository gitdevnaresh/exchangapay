...
const DrawerModal = (props: any) => {
  ...
  const [pricingModelVisible, setPricingModelVisible] =
    ...
    <SafeAreaView style={[commonStyles.screenBg, commonStyles.flex1]}>
        ...
        <Container style={commonStyles.container}>
          ...
          >
            ...
            >
              ...
              >
                <Icon
                  name={DRAWER_CONSTATNTS.ARROW_LEFT}
                  size={s(22)}
              ...
              <ParagraphComponent
                text={DRAWER_CONSTATNTS.PROFILE}
                style={[
                  commonStyles.fs16,
                  commonStyles.fw700,
              ...
              <View style={[commonStyles.flex1]}>
                <View>
                  ...
                  >
                    ...
                    <ParagraphComponent
                      text={hideEmail(decryptAES(userInfo.email)) || ""}
                      style={[
                        commonStyles.fs14,
                        commonStyles.fw500,
          ...
          <View style={[styles.menuSection]}>
            <TouchableOpacity onPress={handleNavigateToSecurity}>
              <View style={[styles.listFlex]}>
                ...
                >
                  ...
                  <ParagraphComponent
                    text={DRAWER_CONSTATNTS.SECURITY_CENTER}
                    style={[
                      commonStyles.fs14,
                      commonStyles.textBlack,
                      commonStyles.fw500,
            ...
            <TouchableOpacity onPress={handleNavigateProfileInfo}>
              <View style={[styles.listFlex]}>
                ...
                >
                  ...
                  <ParagraphComponent
                    text={DRAWER_CONSTATNTS.ACCOUNT_INFORMATION}
                    style={[
                      commonStyles.fs14,
                      commonStyles.textBlack,
                      commonStyles.fw500,
            ...
            <View style={[commonStyles.hLine, styles.py16]} />
            <View>
              <TouchableOpacity onPress={navigatePersonalinfo}>
                <View style={[styles.listFlex]}>
                  <View
                    style={[
                      commonStyles.dflex,
                  ...
                  >
                    ...
                    <ParagraphComponent
                      text={DRAWER_CONSTATNTS.PERSONAL_INFORMATION}
                      style={[
                        commonStyles.fs14,
                        commonStyles.textBlack,
                        commonStyles.fw500,
                ...
                <TouchableOpacity onPress={handleEditPress}>
                  <View style={[styles.listFlex]}>
                    ...
                    >
                      ...
                      <ParagraphComponent
                        text={DRAWER_CONSTATNTS.KYC_INFORMATION}
                        style={[
                          commonStyles.fs14,
                          commonStyles.textBlack,
                          commonStyles.fw500,
            ...
            <View>
              <TouchableOpacity onPress={HandleNavigateRefarral}>
                <View style={[styles.listFlex]}>
                  ...
                  >
                    <Ionicons
                      name={DRAWER_CONSTATNTS.GIFT_OUTLINE}
                      color={NEW_COLOR.TEXT_GREY}
                      size={22}
                    />
                    <ParagraphComponent
                      text={DRAWER_CONSTATNTS.MY_REFERRALS}
                      style={[
                        commonStyles.fs14,
                        commonStyles.textBlack,
                        commonStyles.fw500,
            ...
            <TouchableOpacity onPress={handlePriceCurrenyModel}>
              <View style={[styles.listFlex]}>
                ...
                >
                  ...
                  <ParagraphComponent
                    text={DRAWER_CONSTATNTS.PRICING_CURRENCY}
                    style={[
                      commonStyles.fs14,
                      commonStyles.textBlack,
                      commonStyles.fw500,
            ...
            <TouchableOpacity>
              <View style={[styles.listFlex]}>
                ...
                >
                  ...
                  <ParagraphComponent
                    text={DRAWER_CONSTATNTS.DISPLAY_LANGUAGE}
                    style={[
                      commonStyles.fs14,
                      commonStyles.textBlack,
                      commonStyles.fw500,
                ...
                <View style={[commonStyles.dflex, commonStyles.gap16]}>
                  <ParagraphComponent
                    text={DRAWER_CONSTATNTS.ENGLISH}
                    style={[
                      commonStyles.textGrey,
                      commonStyles.fs12,
                      commonStyles.fw500,
            ...
            <TouchableOpacity>
              <View style={[styles.listFlex]}>
                ...
                >
                  ...
                  <ParagraphComponent
                    text={DRAWER_CONSTATNTS.VERSION}
                    style={[
                      commonStyles.fs14,
                      commonStyles.textBlack,
                      commonStyles.fw500,
            ...
            <TouchableOpacity onPress={handleNavigateHelpCentre}>
              <View style={[styles.listFlex]}>
                ...
                >
                  ...
                  <ParagraphComponent
                    text={DRAWER_CONSTATNTS.HELP_CENTER_FAQ}
                    style={[
                      commonStyles.fs14,
                      commonStyles.textBlack,
                      commonStyles.fw500,
      ...
      {pricingModelVisible && (
        <BaseCurrency
          ...
          updatemodelvisible={(isLoad: boolean) => {
            if (isLoad) {
              getMemDetails();
            } else {
              setPricingModelVisible(false);
